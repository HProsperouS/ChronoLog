...
const seedRules: SeedRule[] = [
  // Automatic rules based on app name
  ...
  // Manual Rules
  { appName: 'Firefox', category: 'Meetings', isAutomatic: false, keywords: ['meet.google.com', 'zoom', 'teams.microsoft.com', 'webex'] },
  { appName: 'Firefox', category: 'Gaming', isAutomatic: false, keywords: ['store.steampowered.com', 'steam'] },
  { appName: 'Firefox', category: 'Study', isAutomatic: false, keywords: ['lecture', 'course', 'tutorial', 'revision', 'slides', 'assignment', 'notes', 'canvas', 'lms', 'moodle'] },
  ...
  { appName: 'Firefox', category: 'Entertainment', isAutomatic: false, keywords: ['netflix', 'spotify', 'twitch', 'disneyplus'] },

  { appName: 'Google Chrome', category: 'Meetings', isAutomatic: false, keywords: ['meet.google.com', 'zoom', 'teams.microsoft.com', 'webex'] },
  { appName: 'Google Chrome', category: 'Gaming', isAutomatic: false, keywords: ['store.steampowered.com', 'steam'] },
  { appName: 'Google Chrome', category: 'Study', isAutomatic: false, keywords: ['lecture', 'course', 'tutorial', 'revision', 'slides', 'assignment', 'notes', 'canvas', 'lms', 'moodle'] },
  ...
  { appName: 'Google Chrome', category: 'Entertainment', isAutomatic: false, keywords: ['netflix', 'spotify', 'twitch', 'disneyplus'] },
];
...
const seedActivities: SeedActivity[] = [
  ...
  makeActivity(monday, '02:22', '03:15', 'Visual Studio Code', 'ChronoLog tracker.ts', undefined, 'Deep Work'),
  ...
  makeActivity(monday, '03:17', '04:00', 'Adobe Acrobat', 'CN Week 8 Slides.pdf', undefined, 'Study'),
  makeActivity(monday, '04:00', '04:15', 'Slack', 'Study Group Planning', undefined, 'Communication'),
  makeActivity(monday, '04:15', '04:30', 'Firefox', 'ChatGPT - algorithm explanation', 'https://chat.openai.com/c/demo-monday-1', 'Deep Work'),
  ...
  // Tuesday - work heavy
  makeActivity(tuesday, '01:00', '01:50', 'Cursor', 'Insights.tsx', undefined, 'Deep Work'),
  makeActivity(tuesday, '01:50', '02:20', 'Firefox', 'ChatGPT - prompt tuning', 'https://chat.openai.com/c/demo-1', 'Deep Work'),
  ...
  makeActivity(tuesday, '04:05', '04:20', 'Adobe Acrobat', 'Client Notes.pdf', undefined, 'Study'),
  ...
  makeActivity(tuesday, '04:53', '04:56', 'Adobe Acrobat', 'Reference Snippet.pdf', undefined, 'Study'),
  ...
  makeActivity(wednesday, '01:02', '01:03', 'Firefox', 'ChatGPT - random browsing', 'https://chat.openai.com/c/demo-2', 'Deep Work'),
  ...
  makeActivity(wednesday, '02:10', '02:40', 'Visual Studio Code', 'Assignment 2', undefined, 'Deep Work'),
  makeActivity(wednesday, '02:40', '02:55', 'Adobe Acrobat', 'Game Review Notes.pdf', undefined, 'Study'),
  ...
  makeActivity(thursday, '01:35', '02:10', 'Firefox', 'Stack Overflow - Typescript generics', 'https://stackoverflow.com/questions/12345', 'Deep Work'),
  makeActivity(thursday, '02:10', '02:40', 'Adobe Acrobat', 'Research Paper.pdf', undefined, 'Study'),
  ...
  makeActivity(friday, '02:15', '02:45', 'Google Chrome', 'ChatGPT - architecture brainstorming', 'https://chat.openai.com/c/demo-3', 'Deep Work'),
  makeActivity(friday, '02:45', '03:20', 'Visual Studio Code', 'activity.service.ts', undefined, 'Deep Work'),
  makeActivity(friday, '03:20', '03:24', 'ChronoLog', 'ChronoLog - Dashboard', undefined, 'ChronoLog', true),
  makeActivity(friday, '03:24', '03:40', 'Adobe Acrobat', 'Meeting Summary.pdf', undefined, 'Study'),
  ...
  // Saturday - sparse day
  makeActivity(saturday, '05:00', '05:20', 'Adobe Acrobat', 'Algorithm Notes.pdf', undefined, 'Study'),
  ...
  makeActivity(saturday, '06:15', '06:30', 'Firefox', 'ChatGPT - study planning', 'https://chat.openai.com/c/demo-sat-1', 'Deep Work'),
  ...
  makeActivity(sunday, '01:02', '01:03', 'Firefox', 'ChatGPT - CN question', 'https://chat.openai.com/c/demo-4', 'Deep Work'),
  makeActivity(sunday, '01:03', '01:04', 'Firefox', 'YouTube - trailer', 'https://www.youtube.com/watch?v=trailer-1', 'Entertainment'),
  makeActivity(sunday, '01:04', '01:35', 'Visual Studio Code', 'tracker.ts', undefined, 'Deep Work'),
  ...
  makeActivity(sunday, '02:05', '02:20', 'Adobe Acrobat', 'Weekly Review Notes.pdf', undefined, 'Study'),
  ...
  makeActivity(sunday, '02:50', '02:53', 'Adobe Acrobat', 'Short Memo.pdf', undefined, 'Study'),
