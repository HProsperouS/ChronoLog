          ...
          <div className="flex gap-3">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-white leading-relaxed space-y-2">
                ...
                <p>
                  <strong className="text-white">Automatic rules</strong> set the default category for an app and are only used when no manual rule matches.
                </p>
                <p>
                  <strong className="text-white">Simple manual rules</strong> use keywords. A simple rule matches when any keyword appears in the window title.
                </p>
                <p>
                  <strong className="text-white">Advanced manual rules</strong> use multiple window title conditions. You can choose whether the rule matches when <strong className="text-white">Any</strong> title condition matches or only when <strong className="text-white">All</strong> title conditions match.
                </p>
                <p>
                  When multiple manual rules could match, ChronoLog uses this priority order:
                  <br />
                  <strong className="text-white">Advanced (All)</strong> → <strong className="text-white">Advanced (Any)</strong> → <strong className="text-white">Simple</strong> → <strong className="text-white">Automatic</strong>.
                </p>
                <p>
                ...
                <p>
                  Advanced rules currently use <strong className="text-white">window title only</strong>, because that is the most reliable cross-browser signal.
                </p>
                <p>
                  Example:
                  <br />
